...
@Component({
  ...
  template:`<span class = "light" [style.visibility]='linkShow' (click)=" myFuncGynecology(true)">
...
linkShow= 'visible';
  ...
  myFuncGynecology(status){
    ...
    if(status) {
     ...
     this.aboutustextgynecologic = this.productsService.gynecologicData();
      return this.modal.open(CustomModal,  overlayConfigFactory({ num1: 2, num2: 3,dataIn: this.aboutustextgynecologic, title: "Gynecology", }, BSModalContext));
