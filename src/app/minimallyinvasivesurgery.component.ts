...
@Component({
  selector: 'minimallyinvasivesurgery',  
  styleUrls: ['./app.component.css'],  
  template:`<span class = "light" [style.visibility]='linkShow' (click)="myFuncMinimallyinvasivesurgery(true)">
...
export class MinimallyinvasivesurgeryComponent implements OnInit{
aboutustextminimallyinvasivesurgery:string; 
...
linkShow= 'visible';
  ...
  myFuncMinimallyinvasivesurgery(status){
    ...
    if(status) {
     ...
     this.aboutustextminimallyinvasivesurgery = this.productsService.minimallyinvasivesurgeryData();
     return this.modal.open(CustomModal,  overlayConfigFactory({ num1: 2, num2: 3,dataIn: this.aboutustextminimallyinvasivesurgery, title: "Minimally Invasive Surgery", }, BSModalContext));
