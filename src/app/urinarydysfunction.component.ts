...
@Component({
  selector: 'urinarydysfunction',  
  styleUrls: ['./app.component.css'],  
  template:`<span class = "light" [style.visibility]='linkShow' (click)="myFuncUrinarydysfunction(true)">
...
export class UrinarydysfunctionComponent implements OnInit{
aboutustexturinarydysfunction:string; 
...
linkShow= 'visible';
  ...
  myFuncUrinarydysfunction(status){
    ...
    if(status) {
     ...
     this.aboutustexturinarydysfunction = this.productsService.urinarydysfunctionData();
     return this.modal.open(CustomModal,  overlayConfigFactory({ num1: 2, num2: 3,dataIn: this.aboutustexturinarydysfunction, title: "Urinary Dysfunction", }, BSModalContext));
